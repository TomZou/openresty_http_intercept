local http_headers = require "lualib.http_headers"
...
function _M.read_response(self, params)
    ...
    local raw_header, res_headers, err = _receive_headers(sock)
...
function _M.request_uri_by_ip(self, ip, uri, params)
    params = tbl_copy(params or {}) -- Take by value
